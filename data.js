...
function getTooltipFormatter() {
    return function (params) {
        if (params.componentType === 'series') {
            ...
            title.style.color = '#37003c'; 
            title.style.borderBottom = '2px solid #00ff85'; 
            ...
            radarChart.setOption({
                ...
                series: [{
                    ...
                    data: [{
                        ...
                        name: dataItem.team,
                        areaStyle: { color: 'rgba(0, 255, 133, 0.4)' }, 
                        lineStyle: { color: '#00ff85', width: 2 }, 
                        itemStyle: { color: '#37003c' } 
                    }]
                }]
            });
